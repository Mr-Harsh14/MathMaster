          ...
          <div className="absolute inset-0 bg-opacity-75 backdrop-filter backdrop-blur-lg">
            <div className="flex h-full items-center justify-center p-12">
              <div className="max-w-lg text-center text-white">
                <h2 className="text-3xl font-bold mb-4">Welcome Back to MathMaster</h2>
                <p className="text-lg">
                  Continue your journey of mastering mathematics through interactive learning and real-time feedback.
                </p>
              </div>
            </div>
          </div>
